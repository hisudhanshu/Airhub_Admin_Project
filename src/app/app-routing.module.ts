...
const routes: Routes = [
  ...
  { path: 'createplan', component: CreatePlansComponent},
  { path: 'viewplan', component: ViewPlansComponent},
  { path: 'topup', component: RechargableTopupComponent},
  { path: 'planorderset', component: PlanOrderSetComponent},
  { path: 'viewcountryform', component: ViewCountryFormComponent},
  { path: 'createcountryform', component: CreateCountryFormComponent},
  { path: 'createoperator', component: CreateOperatorComponent},
  { path: 'createaffiliate', component: CreateAffiliateComponent},
  { path: 'external', component: ManageBlogExternalComponent},
  { path: 'api', component: APIOrderManagementComponent},
  { path: 'tickets', component: TicketsComponent},
  { path: 'complaint', component: ManageSubComplaintComponent},
  { path: 'affiliate', component: ViewAffiliateComponent},
  { path: 'us', component: ViewContactUsComponent},
  { path: 'partner', component: ViewPartnerComponent},
  { path: 'check', component: CheckOutReportsComponent},
  { path: 'h20', component: H20ReportsComponent},
  { path: 'sale', component: SaleReportsComponent},
  { path: 'signupreports', component: SignupReportsComponent},
  { path: 'sub', component: SubscriptionReportsComponent},
  { path: 'web', component: WebsiteInventoryComponent},
  { path: 'data', component: DataSyncComponent},
  { path: 'kyc',component: KYCUsersComponent},
